    ...
    For i As Integer = 0 To sortKeys.Length - 1
        ...
        Else
            If IsNothing(sortKey.PropertyInfo) Then
                If Not m_bMsg Then
                    MsgBox( _
                        "Une clé de comparaison est introuvable : le champ indiqué n'existe pas" & vbLf & _
                        "ou bien n'est pas de portée publique !" & vbLf & _
                        GetType(T).ToString & " : " & sortKeys(i).sMemberName & " : " & m_sTri, _
