...
Partial Class frmPrenomMixte
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmPrenomMixte))
        ...
        Me.ToolTip1.SetToolTip(Me.cmdAnalyser, "Analyser le fichier des prénoms de l'INSEE et produire les rapports sur les préno" &
        "ms mixtes et prénoms fréquents")
        Me.cmdAnalyser.UseVisualStyleBackColor = True
        '
        'cmdExporter
        '
        Me.cmdExporter.Location = New System.Drawing.Point(141, 21)
        ...
        Me.ToolTip1.SetToolTip(Me.cmdExporter, "Exporter le fichier des prénoms de l'INSEE en y ajoutant les colonnes corresponda" &
        ...
        Me.ClientSize = New System.Drawing.Size(454, 161)
